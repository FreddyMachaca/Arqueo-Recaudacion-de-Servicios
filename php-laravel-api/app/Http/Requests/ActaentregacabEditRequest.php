...
class ActaentregacabEditRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"punto_recaud_id" => "filled|numeric",
				"ae_fecha" => "nullable|date",
				"ae_grupo" => "nullable|string",
				"ae_operador1erturno" => "nullable",
				"ae_operador2doturno" => "nullable",
