    ...
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Actaentregadet"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="aed_actaid" header="Aed Actaid" body={AedActaidTemplate}  ></Column>
                                    <Column  field="ae_actaid" header="Ae Actaid"   ></Column>
                                    <Column  field="servicio_id" header="Servicio Id"   ></Column>
                                    <Column  field="aed_desdenumero" header="Aed Desdenumero"   ></Column>
                                    <Column  field="aed_hastanumero" header="Aed Hastanumero"   ></Column>
                                    <Column  field="aed_vendidohasta" header="Aed Vendidohasta"   ></Column>
                                    <Column  field="aed_cantidad" header="Aed Cantidad"   ></Column>
                                    <Column  field="aed_importebs" header="Aed Importebs"   ></Column>
                                    <Column  field="aed_estado" header="Aed Estado"   ></Column>
                                    <Column  field="aed_preciounitario" header="Aed Preciounitario"   ></Column>
