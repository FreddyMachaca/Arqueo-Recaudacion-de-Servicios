...
const ArqueodetcortesAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="ArqueodetcortesAddPage" className="main-page">
    { (props.showHeader) && 
...
ArqueodetcortesAddPage.defaultProps = {
	primaryKey: 'arqueodetcorteid',
	pageName: 'arqueodetcortes',
	apiPath: 'arqueodetcortes/add',
	routeName: 'arqueodetcortesadd',
...
export default ArqueodetcortesAddPage;
