...
const TblserviciosListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblservicios/view/${data.servicio_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblservicios/edit/${data.servicio_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function ServicioIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblservicios/view/${data.servicio_id}`}> { data.servicio_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblserviciosListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Servicios"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblservicios/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="servicio_id" header="Servicio Id" body={ServicioIdTemplate}  ></Column>
                                    <Column  field="servicio_abreviatura" header="Servicio Abreviatura"   ></Column>
                                    <Column  field="servicio_descripcion" header="Servicio Descripcion"   ></Column>
                                    <Column  field="servicio_precio_base" header="Servicio Precio Base"   ></Column>
                                    <Column  field="servicio_estado" header="Servicio Estado"   ></Column>
...
TblserviciosListPage.defaultProps = {
	primaryKey: 'servicio_id',
	pageName: 'tblservicios',
	apiPath: 'tblservicios/index',
	routeName: 'tblservicioslist',
...
export default TblserviciosListPage;
