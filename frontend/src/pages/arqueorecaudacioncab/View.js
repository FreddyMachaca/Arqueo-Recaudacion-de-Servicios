...
import ArqueorecaudacioncabEditPage from 'pages/arqueorecaudacioncab/Edit';
import useApp from 'hooks/useApp';

import useViewPage from 'hooks/useViewPage';
import MasterDetailPages from './MasterDetailPages';
const ArqueorecaudacioncabViewPage = (props) => {
		const app = useApp();
	...
	function ActionButton(data){
		...
		{
			label: "Edit",
			command: (event) => { app.openPageDialog(<ArqueorecaudacioncabEditPage isSubPage apiPath={`/arqueorecaudacioncab/edit/${data.arqueorecid}`} />, {closeBtn: true }) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	if(pageReady){
		return (
			<div>
<main id="ArqueorecaudacioncabViewPage" className="main-page">
    { (props.showHeader) && 
                            ...
                            <div className="col">
                                ...
                                <div className="mb-3 grid ">
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                ...
                                                <div className="font-bold">{ item.arqueorecid }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">Arqueocorrelativo</div>
                                                <div className="font-bold">{ item.arqueocorrelativo }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
                                    ...
                                    <div className="col-12 md:col-4">
                                        <div className="card flex gap-3 align-items-center card shadow-none p-3 surface-100 ">
                                            <div className="">
                                                <div className="text-400 font-medium mb-1">Arqueonombreoperador</div>
                                                <div className="font-bold">{ item.arqueonombreoperador }</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-12 md:col-4">
...
ArqueorecaudacioncabViewPage.defaultProps = {
	id: null,
	primaryKey: 'arqueorecid',
	pageName: 'arqueorecaudacioncab',
	apiPath: 'arqueorecaudacioncab/view',
	routeName: 'arqueorecaudacioncabview',
...
export default ArqueorecaudacioncabViewPage;
