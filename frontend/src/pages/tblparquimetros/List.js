...
const TblparquimetrosListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tblparquimetros/view/${data.parquimetro_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tblparquimetros/edit/${data.parquimetro_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function ParquimetroIdTemplate(data){
		if(data){
			return (
				<Link to={`/tblparquimetros/view/${data.parquimetro_id}`}> { data.parquimetro_id }</Link>
			);
		}
	}
	...
	return (
<main id="TblparquimetrosListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Parquimetros"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tblparquimetros/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="parquimetro_id" header="Parquimetro Id" body={ParquimetroIdTemplate}  ></Column>
                                    <Column  field="vehiculo_id" header="Vehiculo Id"   ></Column>
                                    <Column  field="punto_servicio_id" header="Punto Servicio Id"   ></Column>
                                    <Column  field="parquimetro_hora_inicio" header="Parquimetro Hora Inicio"   ></Column>
                                    <Column  field="parquimetro_hora_fin" header="Parquimetro Hora Fin"   ></Column>
                                    <Column  field="parquimetro_monto" header="Parquimetro Monto"   ></Column>
...
TblparquimetrosListPage.defaultProps = {
	primaryKey: 'parquimetro_id',
	pageName: 'tblparquimetros',
	apiPath: 'tblparquimetros/index',
	routeName: 'tblparquimetroslist',
...
export default TblparquimetrosListPage;
