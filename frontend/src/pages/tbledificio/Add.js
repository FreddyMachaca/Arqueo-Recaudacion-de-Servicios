...
const TbledificioAddPage = (props) => {
		const app = useApp();
	...
	if(pageReady){
		return (
<main id="TbledificioAddPage" className="main-page">
    { (props.showHeader) && 
...
TbledificioAddPage.defaultProps = {
	primaryKey: 'edificio_id',
	pageName: 'tbledificio',
	apiPath: 'tbledificio/add',
	routeName: 'tbledificioadd',
...
export default TbledificioAddPage;
