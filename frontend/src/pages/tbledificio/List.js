...
const TbledificioListPage = (props) => {
		const app = useApp();
	const filterSchema = {
		search: {
			tagTitle: "Search",
	...
	function ActionButton(data){
		...
		{
			label: "View",
			command: (event) => { app.navigate(`/tbledificio/view/${data.edificio_id}`) },
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			command: (event) => { app.navigate(`/tbledificio/edit/${data.edificio_id}`) },
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
	...
	function EdificioIdTemplate(data){
		if(data){
			return (
				<Link to={`/tbledificio/view/${data.edificio_id}`}> { data.edificio_id }</Link>
			);
		}
	}
	...
	return (
<main id="TbledificioListPage" className="main-page">
    { (props.showHeader) && 
    <section className="page-section mb-3" >
        <div className="container-fluid">
            <div className="grid justify-content-between align-items-center">
                <div className="col " >
                    <Title title="Tbl Edificio"   titleClass="text-2xl text-primary font-bold" subTitleClass="text-500"      separator={false} />
                </div>
                <div className="col-fixed " >
                    <Link to={`/tbledificio/add`}>
                        ...
                        <div >
                            ...
                            <div className="page-records">
                                <DataTable 
                                    ...
                                    <Column  field="edificio_id" header="Edificio Id" body={EdificioIdTemplate}  ></Column>
                                    <Column  field="edificio_nombre" header="Edificio Nombre"   ></Column>
                                    <Column  field="edificio_direccion" header="Edificio Direccion"   ></Column>
...
TbledificioListPage.defaultProps = {
	primaryKey: 'edificio_id',
	pageName: 'tbledificio',
	apiPath: 'tbledificio/index',
	routeName: 'tbledificiolist',
...
export default TbledificioListPage;
